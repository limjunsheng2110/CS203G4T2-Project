    ...
    <div className={`min-h-screen ${theme === 'light' ? 'bg-amber-50' : 'bg-black'} py-8 px-4`}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <p className={`text-xl ${colors.textMuted} mb-8 max-w-2xl mx-auto`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          <div className={`${colors.cardBg} rounded-lg p-6 border ${colors.border} text-center`}>
            <div className="flex justify-center mb-4">
              <div className="p-3 bg-green-100 rounded-full">
                <Globe className="text-green-600" size={32} />
              </div>
            </div>
            <h3 className={`text-lg font-semibold ${colors.text} mb-2`}>Global Coverage</h3>
          ...
          <div className={`${colors.cardBg} rounded-lg p-6 border ${colors.border} text-center`}>
            ...
            <h3 className={`text-lg font-semibold ${colors.text} mb-2`}>Instant Results</h3>
            <p className={`text-sm ${colors.textMuted}`}>
          ...
          <div className={`${colors.cardBg} rounded-lg p-6 border ${colors.border} text-center`}>
            ...
            <h3 className={`text-lg font-semibold ${colors.text} mb-2`}>Cost Savings</h3>
            <p className={`text-sm ${colors.textMuted}`}>
          ...
          <div className={`${colors.cardBg} rounded-lg p-6 border ${colors.border} text-center`}>
            ...
            <h3 className={`text-lg font-semibold ${colors.text} mb-2`}>Trade Compliance</h3>
            <p className={`text-sm ${colors.textMuted}`}>
        ...
        <div className={`${colors.cardBg} rounded-lg p-8 border ${colors.border} mb-16`}>
          <h2 className={`text-3xl font-bold ${colors.text} mb-8 text-center`}>How It Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className={`text-lg font-semibold ${colors.text} mb-2`}>Enter Trade Details</h3>
              <p className={`text-sm ${colors.textMuted}`}>
            ...
            <div className="text-center">
              ...
              <h3 className={`text-lg font-semibold ${colors.text} mb-2`}>Calculate Tariffs</h3>
              <p className={`text-sm ${colors.textMuted}`}>
            ...
            <div className="text-center">
              ...
              <h3 className={`text-lg font-semibold ${colors.text} mb-2`}>Review Results</h3>
              <p className={`text-sm ${colors.textMuted}`}>
